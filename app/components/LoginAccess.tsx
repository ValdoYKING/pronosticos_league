...
const LoginAccess = ({ onClose }: LoginAccessProps) => {
  ...
  const handleSendCode = async (e: React.FormEvent) => {
    ...
    // If not exists, sendAccessCode already showed the error toast
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md glass rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-2xl overflow-hidden">
        {/* Header */}
