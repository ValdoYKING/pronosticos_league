...
import { User, Search, LogIn, Loader2, AlertCircle } from "lucide-react";
...
const LoginAccess = ({ onClose }: LoginAccessProps) => {
  ...
  const handleAccess = async (selectedName?: string) => {
    setNameError("");
    const searchName = selectedName || name.trim();
    ...
    const found = participants.find(p => p.name.toLowerCase() === searchName.toLowerCase());
                    ...
                    {suggestions.map(p => (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-[9px] text-gray-400">Participante</p>
                        </div>
